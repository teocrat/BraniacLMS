...
def forwards_func(apps, schema_editor):
    ...
    News.objects.create(
        ...
        использованием этого приложения. Мы хотим, чтобы они могли видетьвсё, \
    ...
    News.objects.create(
        ...
        среди которых: разработка корпоративной системы управления \веб-проектами на базе 1C-Bitrix",        )
    News.objects.create(
